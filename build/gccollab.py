...
def connect_to_database():
    ...
    # Connection settings for gcconnex
    #db_connection = "mysql+pymysql://{}:{}@192.168.1.99:3306/{}".format(
    #    username, password, database)
    #problems with 52.232.129.202
    # Old connection settings for collab. Uses SSH now (below)
    #  db_connection = "mysql+pymysql://{}:{}@52.232.129.202/{}".format(
    #   username, password, database)
...
class users(object):  # Pulls in the entire users database
    ...
    def department():  # Issue : doesn't pull all members. That's bad.
        ...
        statement = statement.filter(metadata_table.name_id == 27)# was 8667
